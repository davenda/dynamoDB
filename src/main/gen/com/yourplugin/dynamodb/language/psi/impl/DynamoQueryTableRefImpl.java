...
public class DynamoQueryTableRefImpl extends ASTWrapperPsiElement implements DynamoQueryTableRef {

  public DynamoQueryTableRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitTableRef(this);
  }
