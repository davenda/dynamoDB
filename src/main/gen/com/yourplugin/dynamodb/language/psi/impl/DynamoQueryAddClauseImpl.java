...
public class DynamoQueryAddClauseImpl extends ASTWrapperPsiElement implements DynamoQueryAddClause {

  public DynamoQueryAddClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitAddClause(this);
  }
