...
public class DynamoQueryLiteralValueImpl extends ASTWrapperPsiElement implements DynamoQueryLiteralValue {

  public DynamoQueryLiteralValueImpl(@NotNull ASTNode node) {
    super(node);
  }
