...
public class DynamoQueryExistsExprImpl extends ASTWrapperPsiElement implements DynamoQueryExistsExpr {

  public DynamoQueryExistsExprImpl(@NotNull ASTNode node) {
    super(node);
  }
