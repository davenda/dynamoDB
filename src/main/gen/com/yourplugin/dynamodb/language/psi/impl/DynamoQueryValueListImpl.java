...
public class DynamoQueryValueListImpl extends ASTWrapperPsiElement implements DynamoQueryValueList {

  public DynamoQueryValueListImpl(@NotNull ASTNode node) {
    super(node);
  }
