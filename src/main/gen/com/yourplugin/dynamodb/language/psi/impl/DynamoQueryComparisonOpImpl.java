...
public class DynamoQueryComparisonOpImpl extends ASTWrapperPsiElement implements DynamoQueryComparisonOp {

  public DynamoQueryComparisonOpImpl(@NotNull ASTNode node) {
    super(node);
  }
