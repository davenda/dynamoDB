...
public class DynamoQueryDryRunDirectiveImpl extends ASTWrapperPsiElement implements DynamoQueryDryRunDirective {

  public DynamoQueryDryRunDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitDryRunDirective(this);
  }
