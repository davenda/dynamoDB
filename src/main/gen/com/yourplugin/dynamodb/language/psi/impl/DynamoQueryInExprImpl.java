...
public class DynamoQueryInExprImpl extends ASTWrapperPsiElement implements DynamoQueryInExpr {

  public DynamoQueryInExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DynamoQueryValueList getValueList() {
    return findNotNullChildByClass(DynamoQueryValueList.class);
  }
