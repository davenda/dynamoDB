...
public class DynamoQuerySizeComparisonImpl extends ASTWrapperPsiElement implements DynamoQuerySizeComparison {

  public DynamoQuerySizeComparisonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitSizeComparison(this);
  }
  ...
  @Override
  @NotNull
  public DynamoQueryComparisonOp getComparisonOp() {
    return findNotNullChildByClass(DynamoQueryComparisonOp.class);
  }
