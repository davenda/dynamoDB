...
public class DynamoQueryConditionExprImpl extends ASTWrapperPsiElement implements DynamoQueryConditionExpr {

  public DynamoQueryConditionExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DynamoQueryOrExpr getOrExpr() {
    return findNotNullChildByClass(DynamoQueryOrExpr.class);
  }
