...
public class DynamoQueryBeginsWithExprImpl extends ASTWrapperPsiElement implements DynamoQueryBeginsWithExpr {

  public DynamoQueryBeginsWithExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitBeginsWithExpr(this);
  }
