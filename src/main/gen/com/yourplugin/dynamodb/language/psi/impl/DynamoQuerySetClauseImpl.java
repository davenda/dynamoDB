...
public class DynamoQuerySetClauseImpl extends ASTWrapperPsiElement implements DynamoQuerySetClause {

  public DynamoQuerySetClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DynamoQuerySetAssignment> getSetAssignmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DynamoQuerySetAssignment.class);
  }
