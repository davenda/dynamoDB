...
public class DynamoQueryContainsExprImpl extends ASTWrapperPsiElement implements DynamoQueryContainsExpr {

  public DynamoQueryContainsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitContainsExpr(this);
  }
