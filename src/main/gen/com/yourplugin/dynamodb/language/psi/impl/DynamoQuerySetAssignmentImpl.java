...
public class DynamoQuerySetAssignmentImpl extends ASTWrapperPsiElement implements DynamoQuerySetAssignment {

  public DynamoQuerySetAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DynamoQuerySetExpr getSetExpr() {
    return findNotNullChildByClass(DynamoQuerySetExpr.class);
  }
