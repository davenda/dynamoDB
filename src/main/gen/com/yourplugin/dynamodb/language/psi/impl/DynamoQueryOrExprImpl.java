...
public class DynamoQueryOrExprImpl extends ASTWrapperPsiElement implements DynamoQueryOrExpr {

  public DynamoQueryOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DynamoQueryAndExpr> getAndExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DynamoQueryAndExpr.class);
  }
