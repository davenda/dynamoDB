...
public class DynamoQueryAttrPathImpl extends ASTWrapperPsiElement implements DynamoQueryAttrPath {

  public DynamoQueryAttrPathImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DynamoQueryAttrPathSegment> getAttrPathSegmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DynamoQueryAttrPathSegment.class);
  }
