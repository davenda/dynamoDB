...
public class DynamoQueryMathExprImpl extends ASTWrapperPsiElement implements DynamoQueryMathExpr {

  public DynamoQueryMathExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitMathExpr(this);
  }
