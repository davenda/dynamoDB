...
public class DynamoQueryAndExprImpl extends ASTWrapperPsiElement implements DynamoQueryAndExpr {

  public DynamoQueryAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DynamoQueryNotExpr> getNotExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DynamoQueryNotExpr.class);
  }
