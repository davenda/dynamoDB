...
public class DynamoQueryComparisonExprImpl extends ASTWrapperPsiElement implements DynamoQueryComparisonExpr {

  public DynamoQueryComparisonExprImpl(@NotNull ASTNode node) {
    super(node);
  }
