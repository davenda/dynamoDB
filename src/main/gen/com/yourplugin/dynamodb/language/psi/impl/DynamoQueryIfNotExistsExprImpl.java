...
public class DynamoQueryIfNotExistsExprImpl extends ASTWrapperPsiElement implements DynamoQueryIfNotExistsExpr {

  public DynamoQueryIfNotExistsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitIfNotExistsExpr(this);
  }
