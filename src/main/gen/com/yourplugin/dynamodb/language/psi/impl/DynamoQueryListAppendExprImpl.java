...
public class DynamoQueryListAppendExprImpl extends ASTWrapperPsiElement implements DynamoQueryListAppendExpr {

  public DynamoQueryListAppendExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitListAppendExpr(this);
  }
