...
public class DynamoQueryProjectionListImpl extends ASTWrapperPsiElement implements DynamoQueryProjectionList {

  public DynamoQueryProjectionListImpl(@NotNull ASTNode node) {
    super(node);
  }
