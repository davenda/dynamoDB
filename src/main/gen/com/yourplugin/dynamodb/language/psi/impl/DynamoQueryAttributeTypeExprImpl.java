...
public class DynamoQueryAttributeTypeExprImpl extends ASTWrapperPsiElement implements DynamoQueryAttributeTypeExpr {

  public DynamoQueryAttributeTypeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DynamoQueryVisitor visitor) {
    visitor.visitAttributeTypeExpr(this);
  }
