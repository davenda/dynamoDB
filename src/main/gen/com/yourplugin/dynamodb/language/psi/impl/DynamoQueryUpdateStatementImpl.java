...
public class DynamoQueryUpdateStatementImpl extends ASTWrapperPsiElement implements DynamoQueryUpdateStatement {

  public DynamoQueryUpdateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DynamoQueryUpdateClause> getUpdateClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DynamoQueryUpdateClause.class);
  }
