...
public class DynamoQueryNotExprImpl extends ASTWrapperPsiElement implements DynamoQueryNotExpr {

  public DynamoQueryNotExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DynamoQueryPrimaryCondition getPrimaryCondition() {
    return findNotNullChildByClass(DynamoQueryPrimaryCondition.class);
  }
